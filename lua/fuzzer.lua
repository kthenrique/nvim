...
vim.keymap.set("n", "gic", builtin.lsp_incoming_calls, { desc = "Telescope lsp incoming calls" })
vim.keymap.set("n", "goc", builtin.lsp_outgoing_calls, { desc = "Telescope lsp outgoing calls" })
